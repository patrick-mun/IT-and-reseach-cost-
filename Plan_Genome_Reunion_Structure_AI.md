...
> ⚠️ **Point crucial** : Le séquençage WGS (350 individus) est **pris en charge par POPgen**. Le coût du projet côté laboratoire porte essentiellement sur le **génotypage iScan** des 2500 + ~300 familles.
...
| **Interface clinique** | Portail web, API | React + FastAPI |
...
PHASE 5 (mois 8-18)
└─ Modules IA + portail web + validation clinique
```
...
Trois scénarios selon la situation de l'iScan au CHU. **Choisir un seul.**
...
#### 🟡 Scénario 2 — iScan déjà disponible au CHU

L'instrument est en place. Le CHU achète uniquement les consommables directement chez Illumina.

| Poste | Quantité | Tarif direct Illumina | Total |
|-------|----------|-----------------------|-------|
| Puces GDA-8 (prix kit direct, volume ≥ 500) | 2940 | ~65€/échantillon | 191 100€ |
| Réactifs chimie Infinium (hybridation, wash…) | 2940 | ~12€/échantillon | 35 300€ |
| **TOTAL Scénario 2** | | | **~226 000€** |

> *Le temps opérateur est absorbé par les RH internes (technicien de labo, non listé séparément ici).*

---

#### 🔴 Scénario 3 — Acquisition iScan + consommables (équipement neuf)

Le CHU n'a pas d'iScan et souhaite l'internaliser durablement.
...
| Consommables (idem Scénario 2) | 226 000€ |
| **TOTAL Scénario 3** | **~479 000€** |

> *L'iScan amortit son coût sur plusieurs années et projets futurs. En coût projet seul, le Scénario 3 est le plus cher, mais il crée un actif durable pour le CHU.*

---

#### Comparaison des trois scénarios

| | Scénario 1 — Sous-traitance | Scénario 2 — iScan existant | Scénario 3 — iScan à acquérir |
|-|-----------------------------|-----------------------------|-------------------------------|
| **Coût génotypage projet** | ~265 000€ | ~226 000€ | ~479 000€ |
| **Investissement instrument** | 0€ | 0€ | 253 000€ |
| **Autonomie future** | ❌ | ✅ | ✅ |
| **Délai de démarrage** | Rapide (devis → lancement) | Immédiat | +3-4 mois (livraison + install.) |
| **Recommandé si…** | Projet ponctuel | CHU déjà équipé | Stratégie long terme du CHU |

### 4.2 Infrastructure informatique (Phase 0-5)
...
### 4.3 Évolution des besoins matériels — graphique texte

```
BUDGET MATÉRIEL PAR PHASE (K€)
(Scénario 1 — sous-traitance, iScan partenaire)

Phase 0-2: Génotypage GDA-8 tout compris (~90€/éch.)
  ██████████████████████████  265K€
  (2940 échantillons × 90€ — puces + réactifs + scan inclus)

Phase 1-4: Infrastructure IT
  ██████████████████████████████████  334K€

Phase 4-5: IA + logiciels + intégration
  ████████████████  125K€
────────────────────────────────────────────
TOTAL MATÉRIEL Sc.1 (sous-traitance)  ≈ 724K€
TOTAL MATÉRIEL Sc.2 (iScan existant)  ≈ 685K€
TOTAL MATÉRIEL Sc.3 (iScan à acquérir)≈ 938K€
```
...
Le coordinateur IR2 est **indispensable dans les trois propositions** : il pilote le projet, valide les analyses génomiques et encadre les profils juniors. Son coût ne peut pas être réduit sans compromettre la qualité scientifique.
...
**−20% vs référence · Total : 452 000 € CC**
...
| **TOTAL PROPOSITION 1** | | | | **452 000 € CC** |
...
**−28% vs référence · Total : 411 000 € CC**
...
| **TOTAL PROPOSITION 2** | | | | **411 000 € CC** |
...
**−34% vs référence · Total : 372 000 € CC**
...
| **TOTAL PROPOSITION 3** | | | | **372 000 € CC** |
...
|--|-----------|---------|-----------|---------|
| **Coût total CC** | **567 000 €** | **452 000 €** | **411 000 €** | **372 000 €** |
| Économie vs référence | — | 115 000 € | 156 000 € | 195 000 € |
| Réduction | — | −20% | −28% | −34% |
| Nb personnes max simultanées | 5 | 5 | 5 | 6 |
...
EFFECTIF PAR MOIS — PROPOSITION 2
  ...
  M1  : Coordinateur IR2 (1) + Doctorant CIFRE (1) + Stage DevOps 0.5 = 2,5 ETP
  M5  : + Alternant Data Engineer (1)                                  = 3,5 ETP
  M17 : + Alternant Data Scientist IA (1)                              = 4,5 ETP
  M19 : Fin du stage DevOps                                            = 4,0 ETP
  M29 : Alternant DE → CDD IE1 (fin alternance 2 ans)                  = 4,0 ETP
  M36 : Livraison finale
```

---

### Répartition du budget RH — Proposition 2 (411 000 € CC)

```
Coordinateur IR2 (36m)      ███████████████████████████████████  197 340€  (48%)
Doctorant CIFRE (36m)       █████████████████████                 95 292€  (23%)
Alternant Data Eng (34m)    ██████████████████                    65 150€  (16%)
Alternant IA (20m)          ██████████                            43 300€  (11%)
Stage DevOps (6m)           ██                                     9 540€  ( 2%)
```

```
BRUT TOTAL VERSÉ AUX PERSONNES  287 000 €  (70%)
CHARGES PATRONALES              124 000 €  (30%)
─────────────────────────────────────────────────
COÛT EMPLOYEUR TOTAL            411 000 €  (100%)
```
...
CI/CD        : GitLab CI/CD
API          : FastAPI (inférence) + React (portail web)
...
Les totaux ci-dessous combinent le scénario génotypage (Sc. 1/2/3) avec la proposition RH retenue.

#### Budget avec Proposition RH 1 — Stages + CDD + contrat doctoral (452 000 € CC)

| Catégorie | Sc. génotypage 1 — Sous-traité | Sc. génotypage 2 — iScan existant | Sc. génotypage 3 — iScan à acquérir |
|-----------|--------------------------------|-----------------------------------|--------------------------------------|
| Génotypage GDA-8 | 265 000 € | 226 000 € | 226 000 € |
| Système iScan | 0 € | 0 € | 253 000 € |
| Infrastructure IT | 334 000 € | 334 000 € | 334 000 € |
| WGS POPgen | **0 €** | **0 €** | **0 €** |
| **RH Prop. 1 (CC)** | **452 000 €** | **452 000 €** | **452 000 €** |
| Prestation web + formation | 35 000 € | 35 000 € | 35 000 € |
| Contingence (10%) | 108 600 € | 104 700 € | 130 000 € |
| **TOTAL** | **~1 195 000 €** | **~1 152 000 €** | **~1 430 000 €** |

#### Budget avec Proposition RH 2 — Alternance + CIFRE ⭐ (411 000 € CC)
...
| Infrastructure IT | 334 000 € | 334 000 € | 334 000 € |
| WGS POPgen | **0 €** | **0 €** | **0 €** |
| **RH Prop. 2 (CC)** | **411 000 €** | **411 000 €** | **411 000 €** |
| Prestation web + formation | 35 000 € | 35 000 € | 35 000 € |
| Contingence (10%) | 104 500 € | 100 600 € | 125 900 € |
| **TOTAL** | **~1 150 000 €** | **~1 107 000 €** | **~1 385 000 €** |

#### Budget avec Proposition RH 3 — Maximum alternance (372 000 € CC)
...
| Infrastructure IT | 334 000 € | 334 000 € | 334 000 € |
| WGS POPgen | **0 €** | **0 €** | **0 €** |
| **RH Prop. 3 (CC)** | **372 000 €** | **372 000 €** | **372 000 €** |
| Prestation web + formation | 35 000 € | 35 000 € | 35 000 € |
| Contingence (10%) | 100 600 € | 96 700 € | 122 000 € |
| **TOTAL** | **~1 107 000 €** | **~1 064 000 €** | **~1 342 000 €** |

> ✅ **WGS (350 individus) pris en charge par POPgen → 0 €**  
> ✅ **Tous les coûts RH sont charges patronales comprises (43% du brut)**  
> ✅ **Combinaison optimale : Sc. génotypage 2 (iScan existant) + RH Prop. 2 → ~1 107 000 €**
...
ÉQUIPE
 M1  : Coordinateur + Bioinformaticien + DevOps 50%    = 2,5 ETP
 M5  : + Data Engineer                                  = 3,5 ETP
 M17 : + Data Scientist IA                              = 4,5 ETP
 M19 : Fin DevOps                                       = 4,0 ETP
 M27 : Fin Data Engineer                                = 3,0 ETP
 M36 : Fin de projet
...
| Défaillance iScan | Faible-Mod. | Downtime 1-2 semaines | SLA contrat Illumina, plateforme partenaire de secours |
...
- Le poste **génotypage iScan** (~226-265K€ selon scénario) est le principal coût biologique
- Le **WGS (POPgen) est gratuit** pour le projet
- Les **ressources humaines** (372-452K€ CC selon proposition) représentent 35-43% du budget total
- La combinaison optimale est : iScan existant au CHU + Proposition RH 2 → **~1 107 000 €** sur 36 mois
